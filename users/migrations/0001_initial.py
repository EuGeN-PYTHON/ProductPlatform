    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comp_name', models.CharField(max_length=120, unique=True, verbose_name='Название компании')),
                ('role', models.CharField(choices=[('Customer', 'Заказчик'), ('Supplier', 'Поставщик')], max_length=120, verbose_name='Роль')),
                ...
                ('kpp', models.CharField(blank=True, max_length=9, unique=True, verbose_name='КПП')),
